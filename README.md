...
### 9. Прочее
* Удалено. Не заметил этой настройки. В файле изменил только исполнение content_scripts на url, которые относятся к youtube. Настройка уже была установлена в шаблоне. Теперь знаю, что она необходима для внедрения каких-либо файлов из расширения.
