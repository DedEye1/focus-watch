...
При смене любой вкладки ютуба на другой сайт таймер останавливается, но режим сохраняется. При возвращении на любую вкладку ютуба - таймер продолжает работу, если режим фокуса включен. На любой другой вкладке нельзя переключать режим - можно только сбросить сессию и поменять настройки.
